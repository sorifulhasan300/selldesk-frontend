...
import type { AuditLogsMeta } from "../types/audit-log.types";
...
export function AuditLogPagination({
  ...
  const hasPrev = meta.hasPreviousPage ?? page > 1;
    ...
    <div className="flex flex-col sm:flex-row items-center justify-between gap-4 px-5 py-3.5 border-t border-admin-line text-[13px] text-admin-text-soft select-none">
      <div className="flex items-center gap-2">
        ...
        <select
          ...
          className="rounded-[8px] border border-admin-line bg-admin-surface px-2 py-1 text-[13px] text-admin-text outline-hidden cursor-pointer hover:border-admin-brand/40"
        >
