...
export interface StoreBrandingUploadProps {
  ...
  /**
   * Notifies parent when a logo is successfully uploaded to Cloudinary
   */
  onLogoChange?: (url: string, publicId?: string) => void;
  /**
   * Notifies parent when a banner is successfully uploaded to Cloudinary
   */
  onBannerChange?: (url: string, publicId?: string) => void;
  /**
   * Notifies parent whether an image upload is currently in progress
   */
...
export function StoreBrandingUpload({
  ...
  useEffect(() => {
    onUploadingChange?.(isUploadingLogo || isUploadingBanner);
  }, [isUploadingLogo, isUploadingBanner, onUploadingChange]);
